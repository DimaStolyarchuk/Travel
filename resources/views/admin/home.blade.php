                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <thead>
                                ...
                                <th scope="col">Перший опис</th>
                                <th scope="col">Другий опис</th>
                                <th scope="col">Третій опис</th>
                                ...
                                @foreach($DataHomes as $dataHome)
                                    <tr>
                                        ...
                                        <td>{{$dataHome->description_1}}</td>
                                        <td>{{$dataHome->description_2}}</td>
                                        <td>{{$dataHome->description_3}}</td>
