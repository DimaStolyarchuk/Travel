                            ...
                            <table class="table">
                                <div class="container-fluid">
                                    <form class="form-horizontal" role="form" action="{{ route('save_contacts') }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="id" value="{{$dataContact->id}}">
                                        <div class="form-group row">
                                            <label for="fname" >Зображення</label>
                                            <div class="col-sm-9">
                                                <input type="file" name="image" class="form-control" id="fname" value="{{$dataContact->image ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="phone" class="form-control" id="email1" value="{{$dataContact->phone ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="cono1">Опис_1</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="description_1" class="form-control" id="cono1" value="{{$dataContact->description_1 ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="cono1">Опис_2</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="description_2" class="form-control" id="cono1" value="{{$dataContact->description_2 ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="cono1">Опис_3</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="description_3" class="form-control" id="cono1" value="{{$dataContact->description_3 ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
