                            ...
                            <table class="table">
                                <div class="container-fluid">
                                    <form class="form-horizontal" role="form" action="{{ route('save_about') }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="id" value="{{$dataAbout->id}}">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label for="email1">Титулка</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="title" class="form-control" id="email1" value="{{$dataAbout->title ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="cono1">Опис</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="description" class="form-control" id="cono1" value="{{$dataAbout->description ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="fname" >Зображення</label>
                                                <div class="col-sm-9">
                                                    <input type="file" name="image" class="form-control" id="fname" value="{{$dataAbout->image ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
