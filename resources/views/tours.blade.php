...
{{--                                <span class="onsale">Гарячий тур!</span>--}}
                                <img src="{{ asset('storage/'. $dataTour->image) }}" alt="">
                                <h3>{{ $dataTour->title }}</h3>
                                <span class="price"><span class="amount">{{ $dataTour->price }}</span></span>
